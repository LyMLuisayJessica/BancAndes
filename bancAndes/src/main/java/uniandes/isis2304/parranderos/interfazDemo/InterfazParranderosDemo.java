...
import uniandes.isis2304.bancAndes.negocio.VOBar;
import uniandes.isis2304.bancAndes.negocio.VOBebedor;
import uniandes.isis2304.bancAndes.negocio.VOBebida;
import uniandes.isis2304.bancAndes.negocio.VOGustan;
import uniandes.isis2304.bancAndes.negocio.VOSirven;
import uniandes.isis2304.bancAndes.negocio.VOTipoBebida;
import uniandes.isis2304.bancAndes.negocio.VOVisitan;
...
//			e.printStackTrace ();
    ...
    public void demoTipoBebida( )
    {
    	try 
    	{
			...
			VOTipoBebida tipoBebida = bancAndes.adicionarTipoBebida (nombreTipoBebida);
			if (tipoBebida == null)
			{
				tipoBebida = bancAndes.darTipoBebidaPorNombre (nombreTipoBebida);
				errorTipoBebida = true;
			}
			List <VOTipoBebida> lista = bancAndes.darVOTiposBebida();
			long tbEliminados = bancAndes.eliminarTipoBebidaPorId (tipoBebida.getId ());
...
//			e.printStackTrace();
	...
	public void demoBebida( )
    {
    	try 
    	{
			...
			VOBebida bebida = bancAndes.adicionarBebida(nombreBebida, tipoBebida.getId (), 10);
			
			List <VOTipoBebida> listaTiposBebida = bancAndes.darVOTiposBebida();
			List <VOBebida> listaBebidas = bancAndes.darVOBebidas();
			long bebEliminadas = bancAndes.eliminarBebidaPorNombre(nombreBebida);
			long tbEliminados = bancAndes.eliminarTipoBebidaPorId (tipoBebida.getId ());
...
//			e.printStackTrace();
    ...
    public void demoElimNoServidas1 ( )
    {
    	try 
    	{
			...
			VOBebida bebida1 = bancAndes.adicionarBebida("120", tipoBebida.getId (), 10);
			VOBebida bebida2 = bancAndes.adicionarBebida("Gato Negro", tipoBebida.getId (), 11);
			VOBebida bebida3 = bancAndes.adicionarBebida("Don Pedro", tipoBebida.getId (), 12);
			
			List <VOTipoBebida> listaTiposBebida = bancAndes.darVOTiposBebida();
			List <VOBebida> listaBebidas1 = bancAndes.darVOBebidas();
			List <VOSirven> listaSirven = bancAndes.darVOSirven ();
			long noServidasEliminadas = bancAndes.eliminarBebidasNoServidas();
			List <VOBebida> listaBebidas2 = bancAndes.darVOBebidas();
			
			long bebEliminadas1 = bancAndes.eliminarBebidaPorId(bebida1.getId ());
			long bebEliminadas2 = bancAndes.eliminarBebidaPorId(bebida2.getId ());
			long bebEliminadas3 = bancAndes.eliminarBebidaPorId(bebida3.getId ());
			long tbEliminados = bancAndes.eliminarTipoBebidaPorNombre (nombreTipoBebida);
...
//			e.printStackTrace();
    ...
    public void demoElimNoServidas2 ( )
    {
    	try 
    	{
			...
			VOBebida bebida2 = bancAndes.adicionarBebida("Gato Negro", tipoBebida.getId (), 11);
			VOBebida bebida3 = bancAndes.adicionarBebida("Don Pedro", tipoBebida.getId (), 12);
			VOBar bar1 = bancAndes.adicionarBar ("Los Amigos", "Bogotá", "Bajo", 2);
			bancAndes.adicionarSirven (bar1.getId (), bebida1.getId (), "diurno");
			
			List <VOTipoBebida> listaTiposBebida = bancAndes.darVOTiposBebida();
			List <VOBebida> listaBebidas1 = bancAndes.darVOBebidas();
			List <VOBar> bares = bancAndes.darVOBares ();
			List <VOSirven> sirven = bancAndes.darVOSirven ();
			long noServidasEliminadas = bancAndes.eliminarBebidasNoServidas();
			List <VOBebida> listaBebidas2 = bancAndes.darVOBebidas();
			
			long sirvenEliminados = bancAndes.eliminarSirven(bar1.getId (), bebida1.getId ());
			long bebEliminadas1 = bancAndes.eliminarBebidaPorId(bebida1.getId ());
			long bebEliminadas2 = bancAndes.eliminarBebidaPorId(bebida2.getId ());
			long bebEliminadas3 = bancAndes.eliminarBebidaPorId(bebida3.getId ());
			long tbEliminados = bancAndes.eliminarTipoBebidaPorNombre (nombreTipoBebida);
			long baresEliminados = bancAndes.eliminarBarPorNombre ("Los Amigos");
...
//			e.printStackTrace();
    ...
    public void demoBar ( )
    {
		try 
		{
			...
			List <VOBar> lista = bancAndes.darVOBares ();
...
//			e.printStackTrace();
    ...
    public void demoBaresBebidas ( )
    {
		try 
		{
			...
			// ATENCIÓN: En una aplicación real, los datos JAMÁS están en el código
			boolean errorTipoBebida = false;
			VOTipoBebida tipoBebida = bancAndes.adicionarTipoBebida ("Vino tinto");
			if (tipoBebida == null)
			{
				tipoBebida = bancAndes.darTipoBebidaPorNombre ("Vino tinto");
				errorTipoBebida = true;
			}
			VOBebida bebida1 = bancAndes.adicionarBebida ("120", tipoBebida.getId (), 10);
			VOBebida bebida2 = bancAndes.adicionarBebida ("121", tipoBebida.getId (), 10);
			VOBebida bebida3 = bancAndes.adicionarBebida ("122", tipoBebida.getId (), 10);
			VOBebida bebida4 = bancAndes.adicionarBebida ("123", tipoBebida.getId (), 10);
			VOBebida bebida5 = bancAndes.adicionarBebida ("124", tipoBebida.getId (), 10);
			VOBar bar1 = bancAndes.adicionarBar ("Los Amigos1", "Bogotá", "Bajo", 2);
			VOBar bar2 = bancAndes.adicionarBar ("Los Amigos2", "Bogotá", "Bajo", 3);
			VOBar bar3 = bancAndes.adicionarBar ("Los Amigos3", "Bogotá", "Bajo", 4);
			VOBar bar4 = bancAndes.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			bancAndes.adicionarSirven (bar1.getId (), bebida1.getId (), "diurno");
			bancAndes.adicionarSirven (bar1.getId (), bebida2.getId (), "diurno");
			bancAndes.adicionarSirven (bar2.getId (), bebida1.getId (), "diurno");
			bancAndes.adicionarSirven (bar2.getId (), bebida2.getId (), "diurno");
			bancAndes.adicionarSirven (bar2.getId (), bebida3.getId (), "diurno");
			bancAndes.adicionarSirven (bar3.getId (), bebida1.getId (), "diurno");
			bancAndes.adicionarSirven (bar3.getId (), bebida2.getId (), "diurno");
			bancAndes.adicionarSirven (bar3.getId (), bebida3.getId (), "diurno");
			bancAndes.adicionarSirven (bar3.getId (), bebida4.getId (), "diurno");
			bancAndes.adicionarSirven (bar3.getId (), bebida5.getId (), "diurno");
			
			List <VOTipoBebida> listaTiposBebida = bancAndes.darVOTiposBebida ();
			List <VOBebida> listaBebidas = bancAndes.darVOBebidas ();
			List <VOBar> listaBares = bancAndes.darVOBares ();
			List <VOSirven> listaSirven = bancAndes.darVOSirven ();

			List <long []> listaByB = bancAndes.darBaresYCantidadBebidasSirven();

			long sirvenEliminados = bancAndes.eliminarSirven (bar1.getId (), bebida1.getId ());
			sirvenEliminados += bancAndes.eliminarSirven (bar1.getId (), bebida2.getId ());
			sirvenEliminados += bancAndes.eliminarSirven (bar2.getId (), bebida1.getId ());
			sirvenEliminados += bancAndes.eliminarSirven (bar2.getId (), bebida2.getId ());
			sirvenEliminados += bancAndes.eliminarSirven (bar2.getId (), bebida3.getId ());
			sirvenEliminados += bancAndes.eliminarSirven (bar3.getId (), bebida1.getId ());
			sirvenEliminados += bancAndes.eliminarSirven (bar3.getId (), bebida2.getId ());
			sirvenEliminados += bancAndes.eliminarSirven (bar3.getId (), bebida3.getId ());
			sirvenEliminados += bancAndes.eliminarSirven (bar3.getId (), bebida4.getId ());
			sirvenEliminados += bancAndes.eliminarSirven (bar3.getId (), bebida5.getId ());
			long bebidasEliminadas = bancAndes.eliminarBebidaPorNombre ("120");
			bebidasEliminadas += bancAndes.eliminarBebidaPorNombre ("121");
			bebidasEliminadas += bancAndes.eliminarBebidaPorNombre ("122");
			bebidasEliminadas += bancAndes.eliminarBebidaPorNombre ("123");
			bebidasEliminadas += bancAndes.eliminarBebidaPorNombre ("124");
			long tbEliminados = bancAndes.eliminarTipoBebidaPorNombre ("Vino tinto");
			long baresEliminados = bancAndes.eliminarBarPorNombre ("Los Amigos1");
			baresEliminados += bancAndes.eliminarBarPorNombre ("Los Amigos2");
			baresEliminados += bancAndes.eliminarBarPorNombre ("Los Amigos3");
			baresEliminados += bancAndes.eliminarBarPorId (bar4.getId ());
...
//			e.printStackTrace();
    ...
    public void demoAumentarSedesBaresEnCiudad ( )
    {
		try 
		{
			...
			long baresModificados = bancAndes.aumentarSedesBaresCiudad("Bogotá");
			List <VOBar> listaBares2 = bancAndes.darVOBares ();

			long baresEliminados = bancAndes.eliminarBarPorId (bar1.getId ());
			baresEliminados += bancAndes.eliminarBarPorId (bar2.getId ());
			baresEliminados += bancAndes.eliminarBarPorId (bar3.getId ());
			baresEliminados += bancAndes.eliminarBarPorId (bar4.getId ());
			// Generación de la cadena de caracteres con la traza de la ejecución de la demo
...
//			e.printStackTrace();
	...
	public void demoBebedor ( )
    {
		try 
		{
    		// Ejecución de la demo y recolección de los resultados
			// ATENCIÓN: En una aplicación real, los datos JAMÁS están en el código
			VOBebedor bdor1 = bancAndes.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOBebedor bdor2 = bancAndes.adicionarBebedor ("Pepito", "Medellín", "Alto");
			VOBebedor bdor3 = bancAndes.adicionarBebedor ("Pedrito", "Cali", "Alto");
			
			List <VOBebedor> bebedores = bancAndes.darVOBebedores();
			VOBebedor bdor5 = bancAndes.darBebedorPorId(bdor1.getId ());
			VOBebedor bdor6 = bancAndes.darBebedorPorId(0);
			List <VOBebedor> pepitos = bancAndes.darVOBebedoresPorNombre("Pepito");
			List <VOBebedor> pedritos = bancAndes.darVOBebedoresPorNombre("Pedrito");
			
			long pepitosEliminados = bancAndes.eliminarBebedorPorNombre ("Pepito");
			long pedritosEliminados = bancAndes.eliminarBebedorPorNombre ("Pedrito");
...
//			e.printStackTrace();
    ...
    public void demoDarBebedorCompleto ( )
    {
		try 
		{
			...
			bancAndes.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			bancAndes.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "nocturno");
			bancAndes.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "todos");
			bancAndes.adicionarGustan (bdor1.getId (), bebida1.getId ());

			List <VOTipoBebida> listaTipos = bancAndes.darVOTiposBebida();
			List <VOBebida> listaBebidas = bancAndes.darVOBebidas();
			List <VOBar> listaBares = bancAndes.darVOBares ();
			List <VOBebedor> bebedores = bancAndes.darVOBebedores();
			List <VOGustan> listaGustan = bancAndes.darVOGustan();
			List <VOVisitan> listaVisitan = bancAndes.darVOVisitan();

			VOBebedor bdor2 = bancAndes.darBebedorCompleto(bdor1.getId ());

			long gustanEliminados = bancAndes.eliminarGustan (bdor1.getId (), bebida1.getId ());
			long bebidasEliminadas = bancAndes.eliminarBebidaPorNombre ("120");
			long tiposEliminados = bancAndes.eliminarTipoBebidaPorNombre ("Vino tinto");
			long [] bebedorVisitasEliminados = bancAndes.eliminarBebedorYVisitas_v1 (bdor1.getId ());
			long baresEliminados = bancAndes.eliminarBarPorNombre ("Los Amigos");
...
//			e.printStackTrace();
    ...
    public void demoEliminarBebedorYVisitas_v2 ( )
    {
		try 
		{
			...
			long bebidasEliminadas = bancAndes.eliminarBebidaPorNombre ("120");
			long tiposEliminados = bancAndes.eliminarTipoBebidaPorNombre ("Vino tinto");
			long [] bebedorVisitasEliminados = bancAndes.eliminarBebedorYVisitas_v2 (bdor1.getId ());
			long baresEliminados = bancAndes.eliminarBarPorNombre ("Los Amigos");
    ...
    */
    public void demoCambiarCiudadBebedor ( )
    {
		try 
		{
			...
			List<VOBebedor> bebedores1 = bancAndes.darVOBebedores ();
			long bebedoresActualizados = bancAndes.cambiarCiudadBebedor (bdor1.getId (), "Medellín");
			List<VOBebedor> bebedores2 = bancAndes.darVOBebedores ();
			
			long bebedoresEliminados = bancAndes.eliminarBebedorPorNombre ("Pepito");
...
//			e.printStackTrace();
    ...
    public void demoBebedoresYNumVisitasRealizadas ( )
    {
		try 
		{
			...
			VOBar bar4 = bancAndes.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			VOBebedor bdor1 = bancAndes.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOBebedor bdor2 = bancAndes.adicionarBebedor ("Juanito", "Bogotá", "Alto");
			VOBebedor bdor3 = bancAndes.adicionarBebedor ("Carlitos", "Medellín", "Alto");
			VOBebedor bdor4 = bancAndes.adicionarBebedor ("Luis", "Cartagena", "Medio");
			bancAndes.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			bancAndes.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "nocturno");
			bancAndes.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "todos");
			bancAndes.adicionarVisitan (bdor1.getId (), bar2.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			bancAndes.adicionarVisitan (bdor1.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			bancAndes.adicionarVisitan (bdor2.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			bancAndes.adicionarVisitan (bdor2.getId (), bar4.getId (), new Timestamp (System.currentTimeMillis()), "diurno");

			List<VOBar> bares = bancAndes.darVOBares();
			List<VOBebedor> bebedores = bancAndes.darVOBebedores();
			List<VOVisitan> visitan = bancAndes.darVOVisitan ();
			List<Object []> bebedoresYNumVisitas = bancAndes.darBebedoresYNumVisitasRealizadas ();

			long [] elimBdor1 = bancAndes.eliminarBebedorYVisitas_v1 (bdor1.getId ());
			long [] elimBdor2 = bancAndes.eliminarBebedorYVisitas_v1 (bdor2.getId ());
			long [] elimBdor3 = bancAndes.eliminarBebedorYVisitas_v1 (bdor3.getId ());
			long [] elimBdor4 = bancAndes.eliminarBebedorYVisitas_v1 (bdor4.getId ());
			long baresEliminados = bancAndes.eliminarBarPorNombre ("Los Amigos1");
			baresEliminados += bancAndes.eliminarBarPorNombre ("Los Amigos2");
			baresEliminados += bancAndes.eliminarBarPorNombre ("Los Amigos3");
			baresEliminados += bancAndes.eliminarBarPorNombre ("Los Amigos4");
...
//			e.printStackTrace();
    ...
    public void demoBebedoresDeCiudad ( )
    {
		try 
		{
			...
			VOBar bar4 = bancAndes.adicionarBar ("Los Amigos4", "Medellín", "Bajo", 5);
			VOBebedor bdor1 = bancAndes.adicionarBebedor ("Pepito", "Bogotá", "Alto");
			VOBebedor bdor2 = bancAndes.adicionarBebedor ("Juanito", "Medellín", "Alto");
			VOBebedor bdor3 = bancAndes.adicionarBebedor ("Pedrito", "Medellín", "Alto");
			bancAndes.adicionarVisitan (bdor1.getId (), bar1.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			bancAndes.adicionarVisitan (bdor1.getId (), bar2.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			bancAndes.adicionarVisitan (bdor1.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			bancAndes.adicionarVisitan (bdor2.getId (), bar3.getId (), new Timestamp (System.currentTimeMillis()), "diurno");
			bancAndes.adicionarVisitan (bdor1.getId (), bar4.getId (), new Timestamp (System.currentTimeMillis()), "diurno");

			List<VOBar> bares = bancAndes.darVOBares();
			List<VOBebedor> bebedores = bancAndes.darVOBebedores();
			List<VOVisitan> visitan = bancAndes.darVOVisitan ();
			long bebedoresBogota = bancAndes.darCantidadBebedoresCiudadVisitanBares ("Bogotá");
			long bebedoresMedellin = bancAndes.darCantidadBebedoresCiudadVisitanBares ("Medellín");

			long [] elimBdor1 = bancAndes.eliminarBebedorYVisitas_v1 (bdor1.getId ());
			long [] elimBdor2 = bancAndes.eliminarBebedorYVisitas_v1 (bdor2.getId ());
			long elimBdor3 = bancAndes.eliminarBebedorPorId (bdor3.getId ());
			long baresEliminados = bancAndes.eliminarBarPorNombre ("Los Amigos1");
			baresEliminados += bancAndes.eliminarBarPorNombre ("Los Amigos2");
			baresEliminados += bancAndes.eliminarBarPorNombre ("Los Amigos3");
			baresEliminados += bancAndes.eliminarBarPorNombre ("Los Amigos4");
...
//			e.printStackTrace();
    ...
    public void demoGustan ( )
    {
		try 
		{
			...
			List <VOTipoBebida> listaTiposBebida = bancAndes.darVOTiposBebida ();
			List <VOBebida> listaBebidas = bancAndes.darVOBebidas ();
			List <VOBebedor> listaBebedores = bancAndes.darVOBebedores ();
			List <VOGustan> listaGustan = bancAndes.darVOGustan();
			long gustanEliminados = bancAndes.eliminarGustan (bdor1.getId (), bebida1.getId ());
			long bebidasEliminadas = bancAndes.eliminarBebidaPorNombre ("120");
			long tbEliminados = bancAndes.eliminarTipoBebidaPorNombre ("Vino tinto");
...
//			e.printStackTrace();
    ...
    public void demoVisitan ( )
    {
		try 
		{
			...
			List <VOBebedor> listaBebedores = bancAndes.darVOBebedores ();
			List <VOVisitan> listaVisitan = bancAndes.darVOVisitan();
			long visitanEliminados = bancAndes.eliminarVisitan (bdor1.getId (), bar1.getId ());
			long baresEliminados = bancAndes.eliminarBarPorNombre ("Los Amigos1");
			long bebedoresEliminadas = bancAndes.eliminarBebedorPorNombre ("Pepito");
