...
//			e.printStackTrace();
    	...
    	try
		{
			...
			VOTipoBebida tipoBebida1 = bancAndes.adicionarTipoBebida (nombreTipoBebida1);
			lista = bancAndes.darVOTiposBebida();
			...
			VOTipoBebida tipoBebida2 = bancAndes.adicionarTipoBebida (nombreTipoBebida2);
			lista = bancAndes.darVOTiposBebida();
			...
			long tbEliminados = bancAndes.eliminarTipoBebidaPorId (tipoBebida1.getId ());
			...
			// Prueba de eliminación de un tipo de bebida, dado su identificador
			tbEliminados = bancAndes.eliminarTipoBebidaPorNombre (nombreTipoBebida2);
			assertEquals ("Debe haberse eliminado un tipo de bebida !!", 1, tbEliminados);
			lista = bancAndes.darVOTiposBebida();
...
//			e.printStackTrace();
		...
		try
		{
			...
			VOTipoBebida tipoBebida2 = bancAndes.adicionarTipoBebida (nombreTipoBebida1);
